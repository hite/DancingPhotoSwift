...
class RootViewController: UIViewController, UIPageViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let startingViewController: DPLayoutPageController = self.modelController.viewControllerAtIndex(0)!
    ...
    internal func pageViewController(_ pageViewController: UIPageViewController, spineLocationFor orientation: UIInterfaceOrientation) -> UIPageViewController.SpineLocation {
        ...
        let currentViewController = self.pageViewController!.viewControllers![0] as! DPLayoutPageController
